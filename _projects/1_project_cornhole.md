...
img: assets/img/projects/01_cornhole/thumbnail.jpeg
date: 2023-05-01
category: Work
---
...
<div class="row">
    <div class="col-md-12">
        <div class="pdf-container">
            <embed src="/assets/pdf/projects/01_cornhole/Poster.pdf" type="application/pdf">
        </div>
    </div>
</div>
...
<a href="/assets/pdf/projects/01_cornhole/Final_Report.pdf" target="_blank" style="display: inline-block; padding: 10px 20px; background-color: #007BFF; color: white; text-decoration: none; border-radius: 5px;">View Final Report</a>
