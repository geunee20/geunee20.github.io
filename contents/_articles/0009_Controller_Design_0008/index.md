...
<div class="col-sm mt-3 mt-md-0">
    {% include figure.liquid loading="eager" path="./assets/img/01_Overall.png" class="img-fluid rounded z-depth-1" zoomable=true %}
</div>
</div>
<div class="caption">
...
<div style="width: 80%; margin: 0 auto;">
<div class="col-sm mt-3 mt-md-0">
    {% include figure.liquid loading="eager" path="./assets/img/02_Controller.png" class="img-fluid rounded z-depth-1" zoomable=true %}
</div>
</div>
<div class="caption">
...
<swiper-container keyboard="true" navigation="true" pagination="true" pagination-clickable="true" pagination-dynamic-bullets="true" rewind="true">
  <swiper-slide>{% include figure.liquid loading="eager" path="./assets/img/03_Eqn_16.png" class="img-fluid rounded z-depth-1" zoomable=true %}
  <div class="caption">
    Figure 3. Equation 16 
  </div>
  </swiper-slide>
  <swiper-slide>{% include figure.liquid loading="eager" path="./assets/img/04_Eqn_17.png" class="img-fluid rounded z-depth-1" zoomable=true %}
  <div class="caption">
    Figure 4. Equation 17
  </div>
  </swiper-slide>
  <swiper-slide>{% include figure.liquid loading="eager" path="./assets/img/05_Eqn_18.png" class="img-fluid rounded z-depth-1" zoomable=true %}
  <div class="caption">
    Figure 5. Equation 18
  </div>
  </swiper-slide>
  <swiper-slide>{% include figure.liquid loading="eager" path="./assets/img/06_Eqn_19.png" class="img-fluid rounded z-depth-1" zoomable=true %}
  <div class="caption">
    Figure 6. Equation 19
  </div>
  </swiper-slide>
  <swiper-slide>{% include figure.liquid loading="eager" path="./assets/img/07_Eqn_20.png" class="img-fluid rounded z-depth-1" zoomable=true %}
  <div class="caption">
    Figure 7. Equation 20
  </div>
  </swiper-slide>
  <swiper-slide>{% include figure.liquid loading="eager" path="./assets/img/08_Eqn_22.png" class="img-fluid rounded z-depth-1" zoomable=true %}
  <div class="caption">
    Figure 8. Equation 22
  </div>
  </swiper-slide>
  <swiper-slide>{% include figure.liquid loading="eager" path="./assets/img/09_Eqn_23.png" class="img-fluid rounded z-depth-1" zoomable=true %}
  <div class="caption">
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include video.liquid path="./assets/video/01_Stability.mp4" class="img-fluid rounded z-depth-1" controls=true muted=true %}
    </div>
</div>
<div class="caption">
...
<div class="col-sm mt-3 mt-md-0">
    {% include figure.liquid loading="eager" path="./assets/img/10_Cx_x.png" class="img-fluid rounded z-depth-1" zoomable=true %}
</div>
</div>
<div class="caption">
...
<div style="width: 60%; margin: 0 auto;">
<div class="col-sm mt-3 mt-md-0">
    {% include figure.liquid loading="eager" path="./assets/img/11_Cx_theta.png" class="img-fluid rounded z-depth-1" zoomable=true %}
</div>
</div>
<div class="caption">
...
<swiper-container keyboard="true" navigation="true" pagination="true" pagination-clickable="true" pagination-dynamic-bullets="true" rewind="true">
  <swiper-slide>
    <div class="row">
      <div class="col-md-6">
        {% include figure.liquid loading="eager" path="./assets/img/12_x_1.png" class="img-fluid rounded z-depth-1" zoomable=true %}
        <div class="caption">
          (a)
        </div>
      </div>
      <div class="col-md-6">
        {% include figure.liquid loading="eager" path="./assets/img/12_theta_1.png" class="img-fluid rounded z-depth-1" zoomable=true %}
        <div class="caption">
          (b)
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-md-6  mx-auto">
        {% include figure.liquid loading="eager" path="./assets/img/12_S_1.png" class="img-fluid rounded z-depth-1" zoomable=true %}
        <div class="caption">
          (c)
        </div>
      </div>
  ...
  <swiper-slide>
    <div class="row">
      <div class="col-md-6">
        {% include figure.liquid loading="eager" path="./assets/img/13_x_2.png" class="img-fluid rounded z-depth-1" zoomable=true %}
        <div class="caption">
          (a)
        </div>
      </div>
      <div class="col-md-6">
        {% include figure.liquid loading="eager" path="./assets/img/13_theta_2.png" class="img-fluid rounded z-depth-1" zoomable=true %}
        <div class="caption">
          (b)
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-md-6  mx-auto">
        {% include figure.liquid loading="eager" path="./assets/img/13_S_2.png" class="img-fluid rounded z-depth-1" zoomable=true %}
        <div class="caption">
          (c)
        </div>
      </div>
  ...
  <swiper-slide>
    <div class="row">
      <div class="col-md-6">
        {% include figure.liquid loading="eager" path="./assets/img/14_x_3.png" class="img-fluid rounded z-depth-1" zoomable=true %}
        <div class="caption">
          (a)
        </div>
      </div>
      <div class="col-md-6">
        {% include figure.liquid loading="eager" path="./assets/img/14_theta_3.png" class="img-fluid rounded z-depth-1" zoomable=true %}
        <div class="caption">
          (b)
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-md-6  mx-auto">
        {% include figure.liquid loading="eager" path="./assets/img/14_S_3.png" class="img-fluid rounded z-depth-1" zoomable=true %}
        <div class="caption">
          (c)
        </div>
      </div>
  ...
  <swiper-slide>
    <div class="row">
      <div class="col-md-6">
        {% include figure.liquid loading="eager" path="./assets/img/15_x_4.png" class="img-fluid rounded z-depth-1" zoomable=true %}
        <div class="caption">
          (a)
        </div>
      </div>
      <div class="col-md-6">
        {% include figure.liquid loading="eager" path="./assets/img/15_theta_4.png" class="img-fluid rounded z-depth-1" zoomable=true %}
        <div class="caption">
          (b)
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-md-6 mx-auto">
        {% include figure.liquid loading="eager" path="./assets/img/15_S_4.png" class="img-fluid rounded z-depth-1" zoomable=true %}
        <div class="caption">
          (c)
        </div>
      </div>
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include video.liquid path="./assets/video/02_K.mp4" class="img-fluid rounded z-depth-1" controls=true muted=true %}
    </div>
</div>
<div class="caption">
...
<swiper-container keyboard="true" navigation="true" pagination="true" pagination-clickable="true" pagination-dynamic-bullets="true" rewind="true">
  <swiper-slide>
    <div class="row">
      <div class="col-md-6">
        {% include figure.liquid loading="eager" path="./assets/img/16_K1_1.png" class="img-fluid rounded z-depth-1" zoomable=true %}
        <div class="caption">
          (a)
        </div>
      </div>
      <div class="col-md-6">
        {% include figure.liquid loading="eager" path="./assets/img/16_K1_4.png" class="img-fluid rounded z-depth-1" zoomable=true %}
        <div class="caption">
          (b)
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-md-6">
        {% include figure.liquid loading="eager" path="./assets/img/16_K1_2.png" class="img-fluid rounded z-depth-1" zoomable=true %}
        <div class="caption">
        (c)
      </div>
      </div>
      <div class="col-md-6">
        {% include figure.liquid loading="eager" path="./assets/img/16_K1_3.png" class="img-fluid rounded z-depth-1" zoomable=true %}
        <div class="caption">
        (d)
      </div>
      </div>
  ...
  <swiper-slide>
    <div class="row">
      <div class="col-md-6">
        {% include figure.liquid loading="eager" path="./assets/img/17_K2_1.png" class="img-fluid rounded z-depth-1" zoomable=true %}
        <div class="caption">
          (a)
        </div>
      </div>
      <div class="col-md-6">
        {% include figure.liquid loading="eager" path="./assets/img/17_K2_4.png" class="img-fluid rounded z-depth-1" zoomable=true %}
        <div class="caption">
          (b)
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-md-6">
        {% include figure.liquid loading="eager" path="./assets/img/17_K2_2.png" class="img-fluid rounded z-depth-1" zoomable=true %}
        <div class="caption">
          (c)
        </div>
      </div>
      <div class="col-md-6">
        {% include figure.liquid loading="eager" path="./assets/img/17_K2_3.png" class="img-fluid rounded z-depth-1" zoomable=true %}
        <div class="caption">
          (d)
        </div>
      </div>
  ...
  <swiper-slide>
    <div class="row">
      <div class="col-md-6">
        {% include figure.liquid loading="eager" path="./assets/img/18_K3_1.png" class="img-fluid rounded z-depth-1" zoomable=true %}
        <div class="caption">
          (a)
        </div>
      </div>
      <div class="col-md-6">
        {% include figure.liquid loading="eager" path="./assets/img/18_K3_4.png" class="img-fluid rounded z-depth-1" zoomable=true %}
        <div class="caption">
          (b)
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-md-6">
        {% include figure.liquid loading="eager" path="./assets/img/18_K3_2.png" class="img-fluid rounded z-depth-1" zoomable=true %}
        <div class="caption">
          (c)
        </div>
      </div>
      <div class="col-md-6">
        {% include figure.liquid loading="eager" path="./assets/img/18_K3_3.png" class="img-fluid rounded z-depth-1" zoomable=true %}
        <div class="caption">
          (d)
        </div>
      </div>
  ...
  <swiper-slide>
    <div class="row">
      <div class="col-md-6">
        {% include figure.liquid loading="eager" path="./assets/img/19_K4_1.png" class="img-fluid rounded z-depth-1" zoomable=true %}
        <div class="caption">
          (a)
        </div>
      </div>
      <div class="col-md-6">
        {% include figure.liquid loading="eager" path="./assets/img/19_K4_4.png" class="img-fluid rounded z-depth-1" zoomable=true %}
        <div class="caption">
          (b)
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-md-6">
        {% include figure.liquid loading="eager" path="./assets/img/19_K4_2.png" class="img-fluid rounded z-depth-1" zoomable=true %}
        <div class="caption">
          (c)
        </div>
      </div>
      <div class="col-md-6">
        {% include figure.liquid loading="eager" path="./assets/img/19_K4_3.png" class="img-fluid rounded z-depth-1" zoomable=true %}
        <div class="caption">
          (d)
        </div>
      </div>
...
<div style="width: 60%; margin: 0 auto;">
  <div class="col-sm mt-3 mt-md-0">
      {% include figure.liquid loading="eager" path="./assets/img/20_sign_vs_sat.png" class="img-fluid rounded z-depth-1" zoomable=true %}
  </div>
</div>
<div class="caption">
...
<div class="row">
  <div class="col-md-6">
    {% include figure.liquid loading="eager" path="./assets/img/20_sat_1.png" class="img-fluid rounded z-depth-1" zoomable=true %}
    <div class="caption">
      (a)
    </div>
  </div>
  <div class="col-md-6">
    {% include figure.liquid loading="eager" path="./assets/img/20_sat_4.png" class="img-fluid rounded z-depth-1" zoomable=true %}
    <div class="caption">
      (b)
    </div>
  </div>
...
<div class="row">
  <div class="col-md-6">
    {% include figure.liquid loading="eager" path="./assets/img/20_sat_2.png" class="img-fluid rounded z-depth-1" zoomable=true %}
    <div class="caption">
      (c)
    </div>
  </div>
  <div class="col-md-6">
    {% include figure.liquid loading="eager" path="./assets/img/20_sat_3.png" class="img-fluid rounded z-depth-1" zoomable=true %}
    <div class="caption">
      (d)
    </div>
  </div>
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include video.liquid path="./assets/video/03_Regulation.mp4" class="img-fluid rounded z-depth-1" controls=true muted=true %}
    </div>
</div>
<div class="caption">
...
<swiper-container keyboard="true" navigation="true" pagination="true" pagination-clickable="true" pagination-dynamic-bullets="true" rewind="true">
  <swiper-slide>
    <div class="row">
      <div class="col-md-6">
        {% include figure.liquid loading="eager" path="./assets/img/21_regulation_0.2_1.png" class="img-fluid rounded z-depth-1" zoomable=true %}
        <div class="caption">
          (a)
        </div>
      </div>
      <div class="col-md-6">
        {% include figure.liquid loading="eager" path="./assets/img/21_regulation_0.2_4.png" class="img-fluid rounded z-depth-1" zoomable=true %}
        <div class="caption">
          (b)
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-md-6">
        {% include figure.liquid loading="eager" path="./assets/img/21_regulation_0.2_2.png" class="img-fluid rounded z-depth-1" zoomable=true %}
        <div class="caption">
        (c)
      </div>
      </div>
      <div class="col-md-6">
        {% include figure.liquid loading="eager" path="./assets/img/21_regulation_0.2_3.png" class="img-fluid rounded z-depth-1" zoomable=true %}
        <div class="caption">
        (d)
      </div>
      </div>
  ...
  <swiper-slide>
    <div class="row">
      <div class="col-md-6">
        {% include figure.liquid loading="eager" path="./assets/img/22_regulation_0.5_1.png" class="img-fluid rounded z-depth-1" zoomable=true %}
        <div class="caption">
          (a)
        </div>
      </div>
      <div class="col-md-6">
        {% include figure.liquid loading="eager" path="./assets/img/22_regulation_0.5_4.png" class="img-fluid rounded z-depth-1" zoomable=true %}
        <div class="caption">
          (b)
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-md-6">
        {% include figure.liquid loading="eager" path="./assets/img/22_regulation_0.5_2.png" class="img-fluid rounded z-depth-1" zoomable=true %}
        <div class="caption">
          (c)
        </div>
      </div>
      <div class="col-md-6">
        {% include figure.liquid loading="eager" path="./assets/img/22_regulation_0.5_3.png" class="img-fluid rounded z-depth-1" zoomable=true %}
        <div class="caption">
          (d)
        </div>
      </div>
...
<swiper-container keyboard="true" navigation="true" pagination="true" pagination-clickable="true" pagination-dynamic-bullets="true" rewind="true">
  <swiper-slide>
    <div class="row">
      <div class="col-md-6">
        {% include figure.liquid loading="eager" path="./assets/img/23_tracking_1.png" class="img-fluid rounded z-depth-1" zoomable=true %}
        <div class="caption">
          (a)
        </div>
      </div>
      <div class="col-md-6">
        {% include figure.liquid loading="eager" path="./assets/img/23_tracking_4.png" class="img-fluid rounded z-depth-1" zoomable=true %}
        <div class="caption">
          (b)
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-md-6">
        {% include figure.liquid loading="eager" path="./assets/img/23_tracking_2.png" class="img-fluid rounded z-depth-1" zoomable=true %}
        <div class="caption">
        (c)
      </div>
      </div>
      <div class="col-md-6">
        {% include figure.liquid loading="eager" path="./assets/img/23_tracking_3.png" class="img-fluid rounded z-depth-1" zoomable=true %}
        <div class="caption">
        (d)
      </div>
      </div>
  ...
  <swiper-slide>
    <div class="row">
      <div class="col-md-6">
        {% include figure.liquid loading="eager" path="./assets/img/24_tracking_sat_1.png" class="img-fluid rounded z-depth-1" zoomable=true %}
        <div class="caption">
          (a)
        </div>
      </div>
      <div class="col-md-6">
        {% include figure.liquid loading="eager" path="./assets/img/24_tracking_sat_4.png" class="img-fluid rounded z-depth-1" zoomable=true %}
        <div class="caption">
          (b)
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-md-6">
        {% include figure.liquid loading="eager" path="./assets/img/24_tracking_sat_2.png" class="img-fluid rounded z-depth-1" zoomable=true %}
        <div class="caption">
          (c)
        </div>
      </div>
      <div class="col-md-6">
        {% include figure.liquid loading="eager" path="./assets/img/24_tracking_sat_3.png" class="img-fluid rounded z-depth-1" zoomable=true %}
        <div class="caption">
          (d)
        </div>
      </div>
  ...
  <swiper-slide>
    <div class="row">
      <div class="col-md-6">
        {% include figure.liquid loading="eager" path="./assets/img/25_regulation_1.png" class="img-fluid rounded z-depth-1" zoomable=true %}
        <div class="caption">
          (a)
        </div>
      </div>
      <div class="col-md-6">
        {% include figure.liquid loading="eager" path="./assets/img/25_regulation_4.png" class="img-fluid rounded z-depth-1" zoomable=true %}
        <div class="caption">
          (b)
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-md-6">
        {% include figure.liquid loading="eager" path="./assets/img/25_regulation_2.png" class="img-fluid rounded z-depth-1" zoomable=true %}
        <div class="caption">
          (c)
        </div>
      </div>
      <div class="col-md-6">
        {% include figure.liquid loading="eager" path="./assets/img/25_regulation_3.png" class="img-fluid rounded z-depth-1" zoomable=true %}
        <div class="caption">
          (d)
        </div>
      </div>
  ...
  <swiper-slide>
    <div class="row">
      <div class="col-md-6">
        {% include figure.liquid loading="eager" path="./assets/img/26_regulation_sat_1.png" class="img-fluid rounded z-depth-1" zoomable=true %}
        <div class="caption">
          (a)
        </div>
      </div>
      <div class="col-md-6">
        {% include figure.liquid loading="eager" path="./assets/img/26_regulation_sat_4.png" class="img-fluid rounded z-depth-1" zoomable=true %}
        <div class="caption">
          (b)
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-md-6">
        {% include figure.liquid loading="eager" path="./assets/img/26_regulation_sat_2.png" class="img-fluid rounded z-depth-1" zoomable=true %}
        <div class="caption">
          (c)
        </div>
      </div>
      <div class="col-md-6">
        {% include figure.liquid loading="eager" path="./assets/img/26_regulation_sat_3.png" class="img-fluid rounded z-depth-1" zoomable=true %}
        <div class="caption">
          (d)
        </div>
      </div>
...
<div style="width: 60%; margin: 0 auto;">
<div class="col-sm mt-3 mt-md-0">
    {% include figure.liquid loading="eager" path="./assets/img/27_Sinusoidal.png" class="img-fluid rounded z-depth-1" zoomable=true %}
</div>
</div>
<div class="caption">
