...
<div class="col-sm mt-3 mt-md-0">
    {% include figure.liquid loading="eager" path="./assets/img/03_Discretization.png" class="img-fluid rounded z-depth-1" zoomable=true %}
</div>
</div>
<div class="caption">
...
<div class="col-sm mt-3 mt-md-0">
    {% include figure.liquid loading="eager" path="./assets/img/04_Augmentation.png" class="img-fluid rounded z-depth-1" zoomable=true %}
</div>
</div>
<div class="caption">
...
<div style="width: 80%; margin: 0 auto;">
<div class="col-sm mt-3 mt-md-0">
    {% include figure.liquid loading="eager" path="./assets/img/05_Optimal_Control.png" class="img-fluid rounded z-depth-1" zoomable=true %}
</div>
</div>
<div class="caption">
...
3. **Quadratic Programming**: This sub-block represents [Equation 42](/blog/2024/Controller-Design-Day-9/#Eq42). It directly calculates $$\Delta U$$ without constraints. For constrained optimization, the `quadprog` function in MATLAB can be used, which is implemented in the Simulink model but not shown in this post.
  ...
  <div style="width: 80%; margin: 0 auto;">
  <div class="col-sm mt-3 mt-md-0">
      {% include figure.liquid loading="eager" path="./assets/img/06_Quadratic_Programming.png" class="img-fluid rounded z-depth-1" zoomable=true %}
  </div>
  </div>
  <div class="caption">
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include video.liquid path="./assets/video/01_Init.mp4" class="img-fluid rounded z-depth-1" controls=true muted=true %}
    </div>
</div>
</div>
<div class="caption">
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include video.liquid path="./assets/video/02_R.mp4" class="img-fluid rounded z-depth-1" controls=true muted=true %}
    </div>
</div>
</div>
<div class="caption">
...
<swiper-container keyboard="true" navigation="true" pagination="true" pagination-clickable="true" pagination-dynamic-bullets="true" rewind="true">
  <swiper-slide>{% include figure.liquid loading="eager" path="./assets/img/07_R_x.png" class="img-fluid rounded z-depth-1" zoomable=true %}
  <div class="caption">
    Figure 7. Effect of R on \( x \)
  </div>
  </swiper-slide>
  <swiper-slide>{% include figure.liquid loading="eager" path="./assets/img/08_R_theta.png" class="img-fluid rounded z-depth-1" zoomable=true %}
  <div class="caption">
    Figure 8. Effect of R on \( \theta \)
  </div>
  </swiper-slide>
  <swiper-slide>{% include figure.liquid loading="eager" path="./assets/img/09_R_work.png" class="img-fluid rounded z-depth-1" zoomable=true %}
  <div class="caption">
...
<div style="width: 60%; margin: 0 auto;">
<div class="col-sm mt-3 mt-md-0">
    {% include figure.liquid loading="eager" path="./assets/img/10_R_robustness.png" class="img-fluid rounded z-depth-1" zoomable=true %}
</div>
</div>
<div class="caption">
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include video.liquid path="./assets/video/03_N.mp4" class="img-fluid rounded z-depth-1" controls=true muted=true %}
    </div>
</div>
</div>
<div class="caption">
...
<div style="width: 60%; margin: 0 auto;">
<swiper-container keyboard="true" navigation="true" pagination="true" pagination-clickable="true" pagination-dynamic-bullets="true" rewind="true">
  <swiper-slide>{% include figure.liquid loading="eager" path="./assets/img/11_N_x.png" class="img-fluid rounded z-depth-1" zoomable=true %}
  <div class="caption">
    Figure 11. Effect of Prediction Horizon on \( x \)
  </div>
  </swiper-slide>
  <swiper-slide>{% include figure.liquid loading="eager" path="./assets/img/12_N_theta.png" class="img-fluid rounded z-depth-1" zoomable=true %}
  <div class="caption">
    Figure 12. Effect of Prediction Horizon on \( \theta \)
  </div>
  </swiper-slide>
  <swiper-slide>{% include figure.liquid loading="eager" path="./assets/img/13_N_work.png" class="img-fluid rounded z-depth-1" zoomable=true %}
  <div class="caption">
...
<div style="width: 60%; margin: 0 auto;">
<div class="col-sm mt-3 mt-md-0">
    {% include figure.liquid loading="eager" path="./assets/img/14_N_robustness.png" class="img-fluid rounded z-depth-1" zoomable=true %}
</div>
</div>
<div class="caption">
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include video.liquid path="./assets/video/04_M.mp4" class="img-fluid rounded z-depth-1" controls=true muted=true %}
    </div>
</div>
</div>
<div class="caption">
...
<div style="width: 60%; margin: 0 auto;">
<swiper-container keyboard="true" navigation="true" pagination="true" pagination-clickable="true" pagination-dynamic-bullets="true" rewind="true">
  <swiper-slide>{% include figure.liquid loading="eager" path="./assets/img/15_M_x.png" class="img-fluid rounded z-depth-1" zoomable=true %}
  <div class="caption">
    Figure 15. Effect of Control Horizon on \( x \)
  </div>
  </swiper-slide>
  <swiper-slide>{% include figure.liquid loading="eager" path="./assets/img/16_M_theta.png" class="img-fluid rounded z-depth-1" zoomable=true %}
  <div class="caption">
    Figure 16. Effect of Control Horizon on \( \theta \)
  </div>
  </swiper-slide>
  <swiper-slide>{% include figure.liquid loading="eager" path="./assets/img/17_M_work.png" class="img-fluid rounded z-depth-1" zoomable=true %}
  <div class="caption">
    Figure 17. Effect of Control Horizon on Energy Consumption
  </div>
  </swiper-slide>
  <swiper-slide>{% include figure.liquid loading="eager" path="./assets/img/18_M_work2.png" class="img-fluid rounded z-depth-1" zoomable=true %}
  <div class="caption">
...
<div style="width: 60%; margin: 0 auto;">
<div class="col-sm mt-3 mt-md-0">
    {% include figure.liquid loading="eager" path="./assets/img/19_tracking.png" class="img-fluid rounded z-depth-1" zoomable=true %}
</div>
</div>
<div class="caption">
...
<div style="width: 60%; margin: 0 auto;">
<div class="col-sm mt-3 mt-md-0">
    {% include figure.liquid loading="eager" path="./assets/img/20_bode_plot.png" class="img-fluid rounded z-depth-1" zoomable=true %}
</div>
</div>
<div class="caption">
