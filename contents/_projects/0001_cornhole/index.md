...
img: ./assets/img/thumbnail.jpeg
date: 2023-05-01
category: Work
permalink: /projects/0001_cornhole/
---
...
<div class="row">
    <div class="col-md-12">
        <div class="pdf-container">
            <iframe src="./assets/pdf/Poster.pdf#navpanes=0" style="width: 100%; height: 100%;" frameborder="0"></iframe>
        </div>
    </div>
</div>
...
<a href="./assets/pdf/Final_Report.pdf" target="_blank" style="display: inline-block; padding: 10px 20px; background-color: #007BFF; color: white; text-decoration: none; border-radius: 5px;">View Final Report</a>
